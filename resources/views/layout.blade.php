...
<head>
  ...
  <link rel="shortcut icons" href="{{asset('images/BemPtsNusra.png')}}">
  ...
  <div class="navbar-fixed">
    <nav>
      ...
      <ul class="dropdown-content" id="dropdown_profil">
        ...
        <li><a href="{{ URL::to('tujuan') }}">VISI & MISI</a></li>
        ...
        <div class="row">
          <div class="col l4 s12">
            ...
            <form id="paypal-donate" action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_top">
              ...
              ">
              <a class="btn waves-effect blue waves-light" href="{{ URL::to('about') }}">Read More
          ...
          <div class="col l4 s12" style="overflow: hidden;">
            ...
            <a href="https://www.facebook.com/groups/183712671974057/" target="_blank">
              <img src="{{ asset('images/facebookIcon.png') }}" width="200px" height="60px">
            </a>
