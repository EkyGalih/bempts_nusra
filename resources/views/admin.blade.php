...
<html>
<head>
	<title>@yield('judul_admin')</title>
	<link rel="stylesheet" href="{{asset('css/materialize.min.css')}}">
	<link rel="stylesheet" href="{{asset('css/icons.css')}}">
	<link rel="stylesheet" href="{{asset('css/inconsolata.css')}}">
  <link rel="stylesheet" href="{{asset('css/galih.css')}}">
	...
	<header>
      ...
      <ul id="nav-mobile" class="side-nav fixed" style="width: 240px;">
        <li class="logo"><a id="logo-container" href="http://materializecss.com/" class="brand-logo">
            <img src="{{ asset('images/BemPtsNusra.png') }}" height="80px" width="100px"></a></li>
        <li class="search">
        ...
        <li class="active">
        <a href="{{ URL::to('beranda') }}" class="waves-effect active waves-teal">
          Beranda
        </a>
        </li>
        <li class="no-padding">
          <ul class="collapsible collapsible-accordion">
            ...
            <a class="collapsible-header active waves-effect waves-teal">
              ...
              <div class="collapsible-body" style="display: block;">
                <ul>
                  <li class="active"><a href="{{ URL::to('agenda') }}">List agenda</a></li>
                  <li><a href="{{ URL::to('add_agenda') }}">Tambah Agenda</a></li>
                </ul>
              </div>
            </li>
            <li class="bold active">
